...
individuals in the `amyloid_df`who were not in the `baseline_df`.
Overall, 479 participants were recruited after exclusions criteria (no
MCI at baseline). The average baseline age was NA years old with
13.1524008 percent of women in the study being a apoe4 carrier, the gene
associated with a higher risk of developing Alzheimer’s disease. When
both data sets were combined (`final_df`), there were 2355 observations
and 8 variables.
